...
export const ARTEMIS_II: MissionConfig = {
  ...
  phases: [
    ...
    { name: 'Launch & Ascent', startTime: '2026-04-01T22:35:12Z', endTime: '2026-04-01T22:53:00Z' },
    { name: 'Earth Orbit', startTime: '2026-04-01T22:53:00Z', endTime: '2026-04-02T00:35:00Z' },
    { name: 'Trans-Lunar Injection', startTime: '2026-04-02T00:35:00Z', endTime: '2026-04-02T01:05:00Z' },
    { name: 'Outbound Coast', startTime: '2026-04-02T01:05:00Z', endTime: '2026-04-06T22:00:00Z' },
    { name: 'Lunar Flyby', startTime: '2026-04-06T22:00:00Z', endTime: '2026-04-07T02:00:00Z' },
    { name: 'Return Coast', startTime: '2026-04-07T02:00:00Z', endTime: '2026-04-11T14:00:00Z' },
    { name: 'Re-entry & Splashdown', startTime: '2026-04-11T14:00:00Z', endTime: '2026-04-11T17:30:00Z' },
  ],
  milestones: [
...
export const MISSIONS: Record<string, MissionConfig> = { 'artemis-ii': ARTEMIS_II }
